...
#     await message.reply(f"Salom {message.from_user.first_name} Menga shahar nomini yuboring, men sizga ob-havo hisobotini yuboraman!")
#
#
# @dp.message_handler()
